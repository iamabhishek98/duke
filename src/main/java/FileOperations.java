    ...
    public static List readFile() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (line[0].equals("T")) {
                    list.markToDo(line[2],Boolean.parseBoolean(line[1]));
                }
                else if (line[0].equals("D")) {
                    list.markDeadline(line[2],Boolean.parseBoolean(line[1]),line[3]);
                }
                else if (line[0].equals("E")) {
                    list.markEvent(line[2],Boolean.parseBoolean(line[1]),line[3]);
                }
            }
            scanner.close();
        } catch (Exception e) {
